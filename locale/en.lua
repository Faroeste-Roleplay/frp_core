i18n.importData("en", {
    error = {
        ...
        fivem_not_found = 'You need to be logged into your FiveM account',
        ...
        server_is_blocked = "Server is locked, only authorized personnel can log in!",
    },
    success = {},
    info = {
        ...
        your_account = '%s \n\n Your account: %s',
        language_changed = 'The language has changed',
