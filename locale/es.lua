i18n.importData("es", {
    error = {
        timeout = "Estás intentando hacer esto demasiado rápido.",
        internal_error = "Se ha producido un error desconocido, comuníquese con el personal.",
        ...
        not_identifier_primary = 'No pudimos encontrar su %s, si tiene alguna pregunta, comuníquese con el personal.',
